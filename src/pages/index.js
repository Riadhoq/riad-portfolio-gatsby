...
const IndexPage = ({ data }) => {
  const projectsFromContentful =
    data.allContentfulProject.nodes && data.allContentfulProject.nodes;
    ...
    <Layout>
      ...
      <section className="projects" id="project">
        <div className="content-container">
          <h2 className="h2 color-black">Projects</h2>
          {projectsFromContentful &&
            projectsFromContentful.map((project) => (
      ...
      <section className="about white" id="about">
        <div className="content-container about-container">
          <div className="about-item">
            ...
            <p className="m-0">
              I am a full stack web developer with a passion for writing{" "}
              <strong>fast, clean, and readable code</strong>.
            </p>
          </div>
          <div className="about-svg-container">
            ...
            >
              ...
              <path
                fill="#d0cde1"
                d="M176 435l29 56s-6 28-17 31-55-35-55-35z"
              />
              <path
                fill="#2f2e41"
              ...
              <path
                fill="#3f3d56"
                d="M1035 153H671V77h364zm-363-2h361V78H672z"
              />
              ...
              <path
                fill="#f2f2f2"
                d="M689 229h118v16H689zM874 229h118v16H874z"
              />
              <path
                fill="#3f3d56"
